...
public class RecyclerViewActivity extends Activity {
    ...
    private void initializeData(){
        ...
        species.add(new Species("Buckthorn", "A shrub or small tree of the buckthorn family, typically bearing thorns. Some kinds yield dyes, and others have been used medicinally.", R.drawable.buckthorn, "How to remove: "));
        species.add(new Species("Japanese Knotweed", "Fallopia japonica, synonym Reynoutria japonica, is a large, herbaceous perennial plant of the knotweed and buckwheat family Polygonaceae. It is native to East Asia in Japan, China and Korea.", R.drawable.japan, "How to remove: "));
        species.add(new Species("Common Tansy", "Tanacetum vulgare, is a perennial, herbaceous flowering plant of the aster family, native to temperate Europe and Asia. It has been introduced to other parts of the world including North America, and in some areas has become invasive. It is also known as common tansy bitter buttons, cow bitter, or golden buttons.", R.drawable.tansy, "How to remove: "));
